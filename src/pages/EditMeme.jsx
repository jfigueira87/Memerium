    ...
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-primary">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form id="formAddMeme" className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <input type="submit" value="Guardar información" className="flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-primary shadow-sm hover:bg-gray-400" />
          </div>
        </form>
      </div>
    </div>
