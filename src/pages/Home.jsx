  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-[#01222B] via-secundary to-[#01222B]">
        <h2 className="text-white text-center sm:text-5xl text-3xl sm:bottom-10 bottom-5 w-full pt-8">CONOCE NUESTROS MEMES</h2>
      ...
      <div className="text-center text-black font-mainFont flex justify-center bg-[#01222B] w-full pb-8">
